          ...
          <form class="w-[100%] mx-auto">
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                name="floating_email"
                id="floating_email"
                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600  focus:outline-none focus:ring-0 focus:border-primary peer"
                placeholder=" "
                required
              />
              <label
            ...
            <div class="relative z-0 w-full mb-5 group">
              <textarea
                ...
                required
                placeholder=" "
                className="px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none block dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-primary peer"
              ></textarea>
            ...
            <button
              type="submit"
              class="text-white bg-primary hover:text-primary shadow-md hover:bg-white  focus:ring-4 focus:outline-none focus:ring-primary font-medium  text-sm w-full sm:w-auto px-5 py-2.5 text-center "
            >
              Submit
            </button>
