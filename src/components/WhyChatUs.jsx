...
export default function WhyChatUs() {
  return (
    <div
      ...
      className="h-[600px]  bg-contain flex justify-center items-center md:mx-[5%] mx-0 rounded-2xl"
    >
      <div class="text-center md:w-[30%] w-[70%] flex flex-col gap-6 justify-center items-center bg-white bg-opacity-50 backdrop-blur-sm rounded-xl p-4">
        ...
        <button class="bg-primary rounded-full text-sm text-white font-bold px-4 py-2 md:w-[40%] w-[60%]">
          CHAT WITH US
        </button>
      </div>
    </div>
